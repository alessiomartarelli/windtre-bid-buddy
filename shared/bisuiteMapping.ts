...
export const FISSO_TARGETS = [
  ...
  { value: 'FIBRA_FTTH_ADDON', label: 'Fibra in tecnologia FTTH' },
  { value: 'VOCE_UNLIMITED', label: 'Voce Unlimited / Call Your Country' },
  { value: 'CONVERGENZA_LUCE_GAS', label: 'Convergenza Luce/Gas' },
  { value: 'CONVERGENTE_ASSICUR', label: 'Convergente Assicur. Casa e Fam.' },
];
...
export function getDefaultMappingRules(): BiSuiteMappingRule[] {
  return [
    ...
    { id: ruleId(), pista: 'mobile', targetCategory: 'PROFESSIONAL_DATA_10', targetLabel: 'Professional Data 10', conditions: { categoriaBiSuite: 'TIED IVA', descrizioneBiSuite: 'PROFESSIONAL DATA 10', descrizioneEscludi: 'PROFESSIONAL DATA 100' }, priority: 15, enabled: true, ruleType: 'base' },
    ...
    { id: ruleId(), pista: 'mobile', targetCategory: 'ALTRE_SIM_IVA', targetLabel: 'Professional Country', conditions: { categoriaBiSuite: 'TIED IVA', descrizioneBiSuite: 'PROFESSIONAL COUNTRY' }, priority: 15, enabled: true, ruleType: 'base' },
    { id: ruleId(), pista: 'mobile', targetCategory: 'ALTRE_SIM_IVA', targetLabel: 'Professional Full Restart', conditions: { categoriaBiSuite: 'TIED IVA', descrizioneBiSuite: 'PROFESSIONAL FULL RESTART' }, priority: 15, enabled: true, ruleType: 'base' },
    ...
    { id: ruleId(), pista: 'fisso', targetCategory: 'FISSO_PIVA_2A_LINEA', targetLabel: 'Fisso P.IVA 2ª Linea', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA IVA', tipologiaBiSuite: 'FIBRA FTTH IVA', descrizioneBiSuite: 'SECONDA LINEA' }, priority: 20, enabled: true, ruleType: 'base' },
    { id: ruleId(), pista: 'fisso', targetCategory: 'FISSO_PIVA_2A_LINEA', targetLabel: 'Fisso P.IVA 2ª Linea', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA IVA', tipologiaBiSuite: 'FIBRA FTTC IVA', descrizioneBiSuite: 'SECONDA LINEA' }, priority: 20, enabled: true, ruleType: 'base' },
    { id: ruleId(), pista: 'fisso', targetCategory: 'FISSO_PIVA_2A_LINEA', targetLabel: 'Fisso P.IVA 2ª Linea', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA IVA', tipologiaBiSuite: 'FWA IVA', descrizioneBiSuite: 'SECONDA LINEA' }, priority: 20, enabled: true, ruleType: 'base' },
    { id: ruleId(), pista: 'fisso', targetCategory: 'FISSO_PIVA_2A_LINEA', targetLabel: 'Fisso P.IVA 2ª Linea', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA IVA', tipologiaBiSuite: 'VOUCHER / BOLLETTINO POSTALE', descrizioneBiSuite: 'SECONDA LINEA' }, priority: 20, enabled: true, ruleType: 'base' },
    ...
    { id: ruleId(), pista: 'fisso', targetCategory: 'FIBRA_FTTH_ADDON', targetLabel: 'Fibra in tecnologia FTTH', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA CF', domandaTesto: 'FIBRA IN TECNOLOGIA FTTH', rispostaContiene: 'SI' }, priority: 20, enabled: true, ruleType: 'additional' },
    { id: ruleId(), pista: 'fisso', targetCategory: 'VOCE_UNLIMITED', targetLabel: 'Voce Unlimited / Call Your Country', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA CF', domandaTesto: 'VOCE UNLIMITED', rispostaContiene: 'SI' }, priority: 20, enabled: true, ruleType: 'additional' },
    { id: ruleId(), pista: 'fisso', targetCategory: 'VOCE_UNLIMITED', targetLabel: 'Voce Unlimited / Call Your Country', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA CF', domandaTesto: 'CALL YOUR COUNTRY HOME', rispostaContiene: 'SI' }, priority: 20, enabled: true, ruleType: 'additional' },
    ...
    { id: ruleId(), pista: 'fisso', targetCategory: 'CONVERGENTE_ASSICUR', targetLabel: 'Convergente Assicur. Casa e Fam.', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA CF', domandaTesto: 'CONVERGENTE ASSICUR. CASA E FAMI', rispostaContiene: 'SI' }, priority: 20, enabled: true, ruleType: 'additional' },
    ...
    { id: ruleId(), pista: 'fisso', targetCategory: 'FIBRA_FTTH_ADDON', targetLabel: 'Fibra in tecnologia FTTH', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA IVA', domandaTesto: 'FIBRA IN TECNOLOGIA FTTH', rispostaContiene: 'SI' }, priority: 20, enabled: true, ruleType: 'additional' },
    { id: ruleId(), pista: 'fisso', targetCategory: 'VOCE_UNLIMITED', targetLabel: 'Voce Unlimited / Call Your Country', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA IVA', domandaTesto: 'VOCE UNLIMITED', rispostaContiene: 'SI' }, priority: 20, enabled: true, ruleType: 'additional' },
    { id: ruleId(), pista: 'fisso', targetCategory: 'VOCE_UNLIMITED', targetLabel: 'Voce Unlimited / Call Your Country', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA IVA', domandaTesto: 'CALL YOUR COUNTRY HOME', rispostaContiene: 'SI' }, priority: 20, enabled: true, ruleType: 'additional' },
    ...
    { id: ruleId(), pista: 'fisso', targetCategory: 'CONVERGENTE_ASSICUR', targetLabel: 'Convergente Assicur. Casa e Fam.', conditions: { categoriaBiSuite: 'ADSL/FIBRA/FWA IVA', domandaTesto: 'CONVERGENTE ASSICUR. CASA E FAMI', rispostaContiene: 'SI' }, priority: 20, enabled: true, ruleType: 'additional' },
    ...
    // ═══════════════ ASSICURAZIONI — BASE ═══════════════
    { id: ruleId(), pista: 'assicurazioni', targetCategory: 'casaFamigliaFull', targetLabel: 'Casa Famiglia Full', conditions: { categoriaBiSuite: 'ASSICURAZIONI', tipologiaBiSuite: 'ASSICURAZIONI CASA', descrizioneBiSuite: 'FULL' }, priority: 15, enabled: true, ruleType: 'base' },
    { id: ruleId(), pista: 'assicurazioni', targetCategory: 'casaFamigliaPlus', targetLabel: 'Casa Famiglia Plus', conditions: { categoriaBiSuite: 'ASSICURAZIONI', tipologiaBiSuite: 'ASSICURAZIONI CASA', descrizioneBiSuite: 'PLUS' }, priority: 15, enabled: true, ruleType: 'base' },
    { id: ruleId(), pista: 'assicurazioni', targetCategory: 'elettrodomestici', targetLabel: 'Elettrodomestici', conditions: { categoriaBiSuite: 'ASSICURAZIONI', tipologiaBiSuite: 'ASSICURAZIONI CASA', descrizioneBiSuite: 'ELETTRODOMESTICI' }, priority: 15, enabled: true, ruleType: 'base' },
    ...
    { id: ruleId(), pista: 'assicurazioni', targetCategory: 'sportIndividuale', targetLabel: 'Sport Individuale', conditions: { categoriaBiSuite: 'ASSICURAZIONI', tipologiaBiSuite: 'ASSICURAZIONI SPORT', descrizioneBiSuite: 'INDIVIDUALE' }, priority: 15, enabled: true, ruleType: 'base' },
