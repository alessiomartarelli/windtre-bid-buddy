...
const generatePDF = (preventivo: Preventivo) => {
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ['Windtre Protetti', formatCurrency(extracted.premioProtecta)],
  ...
  autoTable(doc, {
    ...
    body: [
      ['Mobile', String(extracted.volumiMobile), extracted.puntiMobile.toFixed(2)],
      ['Fisso', String(extracted.volumiFisso), extracted.puntiFisso.toFixed(2)],
    ],
    theme: 'striped',
    headStyles: { fillColor: [59, 130, 246] },
  });
  ...
  if (risultatoMobile?.perPos && risultatoMobile.perPos.length > 0) {
    ...
    autoTable(doc, {
      ...
      body: risultatoMobile.perPos.map((pos) => [
        ...
        (pos.punti || pos.puntiPrevistiFineMese || 0).toFixed(2),
      ]),
      theme: 'striped',
      headStyles: { fillColor: [59, 130, 246] },
    });
...
const generateExcel = (preventivo: Preventivo) => {
  ...
  const riepilogoData = [
    ...
    ['Windtre Protetti', extracted.premioProtecta],
