          ...
          <Card key={pdv.id} className="border-2">
            ...
            <CardContent className="pt-4 space-y-6">
              <div className="space-y-3">
                <h4 className="font-semibold text-sm bg-primary/10 text-primary p-2 rounded">Customer Base Eventi</h4>
