            ...
            <Card>
              ...
              <CardContent>
                {loadingMapped ? (
                  ...
                  <div className="flex items-start gap-2 rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-sm text-amber-900 dark:border-amber-900 dark:bg-amber-950/40 dark:text-amber-200" data-testid="note-no-brand">
                    <AlertTriangle className="h-4 w-4 mt-0.5 shrink-0" />
