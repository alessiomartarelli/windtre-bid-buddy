        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 py-4 sm:py-6">
          <Tabs defaultValue="mobile" className="space-y-4">
            ...
            <TabsList className="bg-muted/50 p-1 w-max sm:w-full">
              ...
              <TabsTrigger value="protecta" className="text-xs sm:text-sm" data-testid="tab-protecta">Windtre Protetti</TabsTrigger>
...
function ProtectaTab({ config, systemConfig, isOverridden, updateValue, resetValue }: SimpleTabProps) {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base">Gettoni per Prodotto Windtre Protetti</CardTitle>
      </CardHeader>
      <CardContent><ScrollableTable>
