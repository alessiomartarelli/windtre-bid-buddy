#!/usr/bin/env bash
# Task #482 — Suite UI contrasto scuro su pagine operative con dati reali
# (tests/dark-contrast-pages-ui.test.mjs).
...
exec node --import tsx --test tests/dark-contrast-pages-ui.test.mjs
