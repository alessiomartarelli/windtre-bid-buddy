...
I campi `fetchedAt` e `lastSync` sono serializzati come istanti ISO con `Z`.
La UI li converte con `timeZone: "Europe/Rome"`, così l’orario visualizzato
segue correttamente l’ora italiana e il passaggio CET/CEST.
