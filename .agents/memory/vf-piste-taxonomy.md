...
- L'HTML Telegram VF mostra pezzi, target S1–S3, premio raggiunto e distanza dalla prossima soglia usando la configurazione globale mensile. Gli override RS non si applicano al report brand/org aggregato, perché scegliere una RS in un perimetro multi-RS sarebbe arbitrario.
- Le config Telegram VF storiche prive delle piste IVA dedicate vanno completate in lettura con IVA Mobile, IVA Wireline e VAS. La proiezione VF usa le piste VF reali, mai Mobile/Fisso P.IVA; anche la pagina Vendite VF nasconde P.IVA generica e “di cui IVA”.
**Why:** il report Telegram aggrega l'intero brand/org, mentre gli override RS hanno senso solo quando il perimetro è inequivocabilmente una singola RS.
